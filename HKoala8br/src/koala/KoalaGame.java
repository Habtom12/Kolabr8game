...
import koala.game.BigExplosion;
...
import koala.game.SmallExplosion;
...
public class KoalaGame extends GameWorld {

    private Thread thread;
    
    // GameWorld is a singleton class!
    private static final KoalaGame game = new KoalaGame();
    ...
    public static KoalaGame getInstance(){
    	return game;
    }
    ...
    public Image getSprite(String name) {
        URL url = KoalaGame.class.getResource(name);
    ...
    public ListIterator<Tank> getPowerUps() {
    ...
    public void drawFrame(int w, int h, Graphics2D g2) {
            ...
            while(players.hasNext() && obj.show){
            	...
            	if (obj.collision(koala)) {
            		if (obj instanceof Tnt || obj instanceof Saw) {
            			koala.setImage(KoalaGame.sprites.get("koala_dead"));
            			gameOver = true;
            			break;
            		}
    	...
    	ArrayList<PlayerTank> playersCopy = new ArrayList<PlayerTank>();
    	...
    	while (players.hasNext()) {
    		...
    		if (gameOver)g2.drawImage(KoalaGame.sprites.get("gameover"),200,200, this);
    		
    	}
    	
    	if (countPlayers()==0) // user won
		g2.drawImage(KoalaGame.sprites.get("congrats"),100,150,this);        
    }
	...
	public static void main(String argv[]) {
	    final KoalaGame game = KoalaGame.getInstance();
